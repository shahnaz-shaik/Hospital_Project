 ...
 * 
 * try { String sql = "select * from user_dtls where email=? and password=?";
 ...
 * false;
 * 
 * try { String sql = "select * from user_dtls where id=? and password=?";
 ...
 * false;
 * 
 * try { String sql = "update user_dtls set password=? where id=?";
