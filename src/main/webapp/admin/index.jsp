...
<style type="text/css">
body {
 	 background-image: url('https://th.bing.com/th/id/OIP.nBvhwPw3r8in90e0UT2e1gHaE8?w=626&h=418&rs=1&pid=ImgDetMain'); 
...
<div class="col-md-4">
	...
	<div class="card paint-card">
		<div class="card-body text-center text-dark">
			...
			<div class="col-md-4">
<a href="patientlist.jsp" style="text-decoration: none;" >
<div class="card paint-card">
<div class="card-body text-center text-dark">
